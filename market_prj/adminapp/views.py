...
from adminapp.forms import AccommodationEditForm, TravelUserAdminEditForm
...
def countries(request):
    ...
    content = {"title": title, "objects": countries_list}
...
def accommodation_delete(request, pk):
    ...
    if request.method == "POST":
        ...
        accommodation.save()
        return HttpResponseRedirect(
            reverse("admin:accommodations", args=[accommodation.country.pk])
        )
    content = {
        "title": title,
